...
// @ts-nocheck 
/*
 * This file exports the `EnterpriseKra` model and its related types.
 *
...
export type EnterpriseKraAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which EnterpriseKra to aggregate.
   */
  where?: Prisma.EnterpriseKraWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   * 
   * Determine the order of EnterpriseKras to fetch.
   */
   ...
   * 
   * Take `±n` EnterpriseKras from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   * 
   * Skip the first `n` EnterpriseKras.
   */
  skip?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Count returned EnterpriseKras
  **/
...
export type GetEnterpriseKraAggregateType<T extends EnterpriseKraAggregateArgs> = {
      [P in keyof T & keyof AggregateEnterpriseKra]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateEnterpriseKra[P]>
    : Prisma.GetScalarType<T[P], AggregateEnterpriseKra[P]>
}
...
export type GetEnterpriseKraGroupByPayload<T extends EnterpriseKraGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<EnterpriseKraGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof EnterpriseKraGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], EnterpriseKraGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], EnterpriseKraGroupByOutputType[P]>
      }
    >
  >
...
/**
 * Count Type EnterpriseKraCountOutputType
 */
...
/**
 * EnterpriseKraCountOutputType without action
 */
export type EnterpriseKraCountOutputTypeDefaultArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Select specific fields to fetch from the EnterpriseKraCountOutputType
   */
...
export type EnterpriseKraCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<EnterpriseKraFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface EnterpriseKraDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['EnterpriseKra'], meta: { name: 'EnterpriseKra' } }
  /**
   * Find zero or one EnterpriseKra that matches the filter.
   * @param {EnterpriseKraFindUniqueArgs} args - Arguments to find a EnterpriseKra
   * @example
   * // Get one EnterpriseKra
   * const enterpriseKra = await prisma.enterpriseKra.findUnique({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find one EnterpriseKra that matches the filter or throw an error with `error.code='P2025'`
   * if no matches were found.
   * @param {EnterpriseKraFindUniqueOrThrowArgs} args - Arguments to find a EnterpriseKra
   * @example
   * // Get one EnterpriseKra
   * const enterpriseKra = await prisma.enterpriseKra.findUniqueOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first EnterpriseKra that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {EnterpriseKraFindFirstArgs} args - Arguments to find a EnterpriseKra
   * @example
   * // Get one EnterpriseKra
   * const enterpriseKra = await prisma.enterpriseKra.findFirst({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first EnterpriseKra that matches the filter or
   * throw `PrismaKnownClientError` with `P2025` code if no matches were found.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {EnterpriseKraFindFirstOrThrowArgs} args - Arguments to find a EnterpriseKra
   * @example
   * // Get one EnterpriseKra
   * const enterpriseKra = await prisma.enterpriseKra.findFirstOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find zero or more EnterpriseKras that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {EnterpriseKraFindManyArgs} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all EnterpriseKras
   * const enterpriseKras = await prisma.enterpriseKra.findMany()
   * 
   * // Get first 10 EnterpriseKras
   * const enterpriseKras = await prisma.enterpriseKra.findMany({ take: 10 })
   * 
   * // Only select the `code`
   * const enterpriseKraWithCodeOnly = await prisma.enterpriseKra.findMany({ select: { code: true } })
   * 
   */
  ...
  /**
   * Create a EnterpriseKra.
   * @param {EnterpriseKraCreateArgs} args - Arguments to create a EnterpriseKra.
   * @example
   * // Create one EnterpriseKra
   * const EnterpriseKra = await prisma.enterpriseKra.create({
   *   data: {
   *     // ... data to create a EnterpriseKra
   *   }
   * })
   * 
   */
  ...
  /**
   * Create many EnterpriseKras.
   * @param {EnterpriseKraCreateManyArgs} args - Arguments to create many EnterpriseKras.
   * @example
   * // Create many EnterpriseKras
   * const enterpriseKra = await prisma.enterpriseKra.createMany({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
  ...
  /**
   * Create many EnterpriseKras and returns the data saved in the database.
   * @param {EnterpriseKraCreateManyAndReturnArgs} args - Arguments to create many EnterpriseKras.
   * @example
   * // Create many EnterpriseKras
   * const enterpriseKra = await prisma.enterpriseKra.createManyAndReturn({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   * 
   * // Create many EnterpriseKras and only return the `code`
   * const enterpriseKraWithCodeOnly = await prisma.enterpriseKra.createManyAndReturn({
   *   select: { code: true },
   *   data: [
   *     // ... provide data here
   *   ]
  ...
  /**
   * Delete a EnterpriseKra.
   * @param {EnterpriseKraDeleteArgs} args - Arguments to delete one EnterpriseKra.
   * @example
   * // Delete one EnterpriseKra
   * const EnterpriseKra = await prisma.enterpriseKra.delete({
   *   where: {
   *     // ... filter to delete one EnterpriseKra
   *   }
   * })
   * 
   */
  ...
  /**
   * Update one EnterpriseKra.
   * @param {EnterpriseKraUpdateArgs} args - Arguments to update one EnterpriseKra.
   * @example
   * // Update one EnterpriseKra
   * const enterpriseKra = await prisma.enterpriseKra.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Delete zero or more EnterpriseKras.
   * @param {EnterpriseKraDeleteManyArgs} args - Arguments to filter EnterpriseKras to delete.
   * @example
   * // Delete a few EnterpriseKras
   * const { count } = await prisma.enterpriseKra.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Update zero or more EnterpriseKras.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {EnterpriseKraUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many EnterpriseKras
   * const enterpriseKra = await prisma.enterpriseKra.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Update zero or more EnterpriseKras and returns the data updated in the database.
   * @param {EnterpriseKraUpdateManyAndReturnArgs} args - Arguments to update many EnterpriseKras.
   * @example
   * // Update many EnterpriseKras
   * const enterpriseKra = await prisma.enterpriseKra.updateManyAndReturn({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: [
   ...
   * })
   * 
   * // Update zero or more EnterpriseKras and only return the `code`
   * const enterpriseKraWithCodeOnly = await prisma.enterpriseKra.updateManyAndReturn({
   *   select: { code: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  /**
   * Create or update one EnterpriseKra.
   * @param {EnterpriseKraUpsertArgs} args - Arguments to update or create a EnterpriseKra.
   * @example
   * // Update or create a EnterpriseKra
   * const enterpriseKra = await prisma.enterpriseKra.upsert({
   *   create: {
   *     // ... data to create a EnterpriseKra
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the EnterpriseKra we want to update
   *   }
   * })
   */
  ...
  /**
   * Count the number of EnterpriseKras.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {EnterpriseKraCountArgs} args - Arguments to filter EnterpriseKras to count.
   * @example
   * // Count the number of EnterpriseKras
   * const count = await prisma.enterpriseKra.count({
   *   where: {
   *     // ... the filter for the EnterpriseKras we want to count
   *   }
   * })
  **/
  count<T extends EnterpriseKraCountArgs>(
    args?: Prisma.Subset<T, EnterpriseKraCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], EnterpriseKraCountAggregateOutputType>
      : number
  >

  /**
   * Allows you to perform aggregations operations on a EnterpriseKra.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {EnterpriseKraAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
   * @example
  ...
  **/
  ...
  /**
   * Group by EnterpriseKra.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {EnterpriseKraGroupByArgs} args - Group by arguments.
   * @example
  ...
  **/
  groupBy<
    T extends EnterpriseKraGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, EnterpriseKraGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEnterpriseKraGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 * Fields of the EnterpriseKra model
 */
readonly fields: EnterpriseKraFieldRefs;
}

/**
 * The delegate class that acts as a "Promise-like" for EnterpriseKra.
...
export type EnterpriseKraFindUniqueArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  /**
   * Filter, which EnterpriseKra to fetch.
   */
  where: Prisma.EnterpriseKraWhereUniqueInput
}

/**
 * EnterpriseKra findUniqueOrThrow
 */
...
export type EnterpriseKraFindFirstArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for searching for EnterpriseKras.
   */
  cursor?: Prisma.EnterpriseKraWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type EnterpriseKraFindManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.EnterpriseKraInclude<ExtArgs> | null
  /**
   * Filter, which EnterpriseKras to fetch.
   */
  where?: Prisma.EnterpriseKraWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for listing EnterpriseKras.
   */
  cursor?: Prisma.EnterpriseKraWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type EnterpriseKraCreateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to create many EnterpriseKras.
   */
...
/**
 * EnterpriseKra createManyAndReturn
 */
...
export type EnterpriseKraUpdateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.EnterpriseKraInclude<ExtArgs> | null
  /**
   * The data needed to update a EnterpriseKra.
   */
  data: Prisma.XOR<Prisma.EnterpriseKraUpdateInput, Prisma.EnterpriseKraUncheckedUpdateInput>
  /**
   * Choose, which EnterpriseKra to update.
   */
  where: Prisma.EnterpriseKraWhereUniqueInput
}

/**
 * EnterpriseKra updateMany
 */
export type EnterpriseKraUpdateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to update EnterpriseKras.
   */
  data: Prisma.XOR<Prisma.EnterpriseKraUpdateManyMutationInput, Prisma.EnterpriseKraUncheckedUpdateManyInput>
  /**
   * Filter which EnterpriseKras to update
   */
  where?: Prisma.EnterpriseKraWhereInput
  /**
   * Limit how many EnterpriseKras to update.
   */
  limit?: number
}

/**
 * EnterpriseKra updateManyAndReturn
 */
...
export type EnterpriseKraUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.EnterpriseKraInclude<ExtArgs> | null
  /**
   * The filter to search for the EnterpriseKra to update in case it exists.
   */
  where: Prisma.EnterpriseKraWhereUniqueInput
  /**
   * In case the EnterpriseKra found by the `where` argument doesn't exist, create a new EnterpriseKra with this data.
   */
  create: Prisma.XOR<Prisma.EnterpriseKraCreateInput, Prisma.EnterpriseKraUncheckedCreateInput>
  /**
   * In case the EnterpriseKra was found with the provided `where` argument, update it with this data.
   */
  update: Prisma.XOR<Prisma.EnterpriseKraUpdateInput, Prisma.EnterpriseKraUncheckedUpdateInput>
}

/**
 * EnterpriseKra delete
 */
export type EnterpriseKraDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.EnterpriseKraInclude<ExtArgs> | null
  /**
   * Filter which EnterpriseKra to delete.
   */
  where: Prisma.EnterpriseKraWhereUniqueInput
}

/**
 * EnterpriseKra deleteMany
 */
export type EnterpriseKraDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which EnterpriseKras to delete
   */
  where?: Prisma.EnterpriseKraWhereInput
  /**
   * Limit how many EnterpriseKras to delete.
   */
  limit?: number
}

/**
 * EnterpriseKra.objectiveMap
 */
