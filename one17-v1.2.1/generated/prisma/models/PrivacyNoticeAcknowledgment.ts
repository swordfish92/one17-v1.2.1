...
// @ts-nocheck 
/*
 * This file exports the `PrivacyNoticeAcknowledgment` model and its related types.
 *
...
export type PrivacyNoticeAcknowledgmentAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which PrivacyNoticeAcknowledgment to aggregate.
   */
  where?: Prisma.PrivacyNoticeAcknowledgmentWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   * 
   * Determine the order of PrivacyNoticeAcknowledgments to fetch.
   */
   ...
   * 
   * Take `±n` PrivacyNoticeAcknowledgments from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   * 
   * Skip the first `n` PrivacyNoticeAcknowledgments.
   */
  skip?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Count returned PrivacyNoticeAcknowledgments
  **/
...
export type GetPrivacyNoticeAcknowledgmentAggregateType<T extends PrivacyNoticeAcknowledgmentAggregateArgs> = {
      [P in keyof T & keyof AggregatePrivacyNoticeAcknowledgment]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePrivacyNoticeAcknowledgment[P]>
    : Prisma.GetScalarType<T[P], AggregatePrivacyNoticeAcknowledgment[P]>
}
...
export type GetPrivacyNoticeAcknowledgmentGroupByPayload<T extends PrivacyNoticeAcknowledgmentGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PrivacyNoticeAcknowledgmentGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PrivacyNoticeAcknowledgmentGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PrivacyNoticeAcknowledgmentGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PrivacyNoticeAcknowledgmentGroupByOutputType[P]>
      }
    >
  >
...
export type PrivacyNoticeAcknowledgmentCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PrivacyNoticeAcknowledgmentFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PrivacyNoticeAcknowledgmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PrivacyNoticeAcknowledgment'], meta: { name: 'PrivacyNoticeAcknowledgment' } }
  /**
   * Find zero or one PrivacyNoticeAcknowledgment that matches the filter.
   * @param {PrivacyNoticeAcknowledgmentFindUniqueArgs} args - Arguments to find a PrivacyNoticeAcknowledgment
   * @example
   * // Get one PrivacyNoticeAcknowledgment
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.findUnique({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find one PrivacyNoticeAcknowledgment that matches the filter or throw an error with `error.code='P2025'`
   * if no matches were found.
   * @param {PrivacyNoticeAcknowledgmentFindUniqueOrThrowArgs} args - Arguments to find a PrivacyNoticeAcknowledgment
   * @example
   * // Get one PrivacyNoticeAcknowledgment
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.findUniqueOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first PrivacyNoticeAcknowledgment that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PrivacyNoticeAcknowledgmentFindFirstArgs} args - Arguments to find a PrivacyNoticeAcknowledgment
   * @example
   * // Get one PrivacyNoticeAcknowledgment
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.findFirst({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first PrivacyNoticeAcknowledgment that matches the filter or
   * throw `PrismaKnownClientError` with `P2025` code if no matches were found.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PrivacyNoticeAcknowledgmentFindFirstOrThrowArgs} args - Arguments to find a PrivacyNoticeAcknowledgment
   * @example
   * // Get one PrivacyNoticeAcknowledgment
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.findFirstOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find zero or more PrivacyNoticeAcknowledgments that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PrivacyNoticeAcknowledgmentFindManyArgs} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all PrivacyNoticeAcknowledgments
   * const privacyNoticeAcknowledgments = await prisma.privacyNoticeAcknowledgment.findMany()
   * 
   * // Get first 10 PrivacyNoticeAcknowledgments
   * const privacyNoticeAcknowledgments = await prisma.privacyNoticeAcknowledgment.findMany({ take: 10 })
   * 
   * // Only select the `id`
   * const privacyNoticeAcknowledgmentWithIdOnly = await prisma.privacyNoticeAcknowledgment.findMany({ select: { id: true } })
   * 
   */
  ...
  /**
   * Create a PrivacyNoticeAcknowledgment.
   * @param {PrivacyNoticeAcknowledgmentCreateArgs} args - Arguments to create a PrivacyNoticeAcknowledgment.
   * @example
   * // Create one PrivacyNoticeAcknowledgment
   * const PrivacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.create({
   *   data: {
   *     // ... data to create a PrivacyNoticeAcknowledgment
   *   }
   * })
   * 
   */
  ...
  /**
   * Create many PrivacyNoticeAcknowledgments.
   * @param {PrivacyNoticeAcknowledgmentCreateManyArgs} args - Arguments to create many PrivacyNoticeAcknowledgments.
   * @example
   * // Create many PrivacyNoticeAcknowledgments
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.createMany({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
  ...
  /**
   * Create many PrivacyNoticeAcknowledgments and returns the data saved in the database.
   * @param {PrivacyNoticeAcknowledgmentCreateManyAndReturnArgs} args - Arguments to create many PrivacyNoticeAcknowledgments.
   * @example
   * // Create many PrivacyNoticeAcknowledgments
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.createManyAndReturn({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   * 
   * // Create many PrivacyNoticeAcknowledgments and only return the `id`
   * const privacyNoticeAcknowledgmentWithIdOnly = await prisma.privacyNoticeAcknowledgment.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
  ...
  /**
   * Delete a PrivacyNoticeAcknowledgment.
   * @param {PrivacyNoticeAcknowledgmentDeleteArgs} args - Arguments to delete one PrivacyNoticeAcknowledgment.
   * @example
   * // Delete one PrivacyNoticeAcknowledgment
   * const PrivacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.delete({
   *   where: {
   *     // ... filter to delete one PrivacyNoticeAcknowledgment
   *   }
   * })
   * 
   */
  ...
  /**
   * Update one PrivacyNoticeAcknowledgment.
   * @param {PrivacyNoticeAcknowledgmentUpdateArgs} args - Arguments to update one PrivacyNoticeAcknowledgment.
   * @example
   * // Update one PrivacyNoticeAcknowledgment
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Delete zero or more PrivacyNoticeAcknowledgments.
   * @param {PrivacyNoticeAcknowledgmentDeleteManyArgs} args - Arguments to filter PrivacyNoticeAcknowledgments to delete.
   * @example
   * // Delete a few PrivacyNoticeAcknowledgments
   * const { count } = await prisma.privacyNoticeAcknowledgment.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Update zero or more PrivacyNoticeAcknowledgments.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PrivacyNoticeAcknowledgmentUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many PrivacyNoticeAcknowledgments
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Update zero or more PrivacyNoticeAcknowledgments and returns the data updated in the database.
   * @param {PrivacyNoticeAcknowledgmentUpdateManyAndReturnArgs} args - Arguments to update many PrivacyNoticeAcknowledgments.
   * @example
   * // Update many PrivacyNoticeAcknowledgments
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.updateManyAndReturn({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: [
   ...
   * })
   * 
   * // Update zero or more PrivacyNoticeAcknowledgments and only return the `id`
   * const privacyNoticeAcknowledgmentWithIdOnly = await prisma.privacyNoticeAcknowledgment.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  /**
   * Create or update one PrivacyNoticeAcknowledgment.
   * @param {PrivacyNoticeAcknowledgmentUpsertArgs} args - Arguments to update or create a PrivacyNoticeAcknowledgment.
   * @example
   * // Update or create a PrivacyNoticeAcknowledgment
   * const privacyNoticeAcknowledgment = await prisma.privacyNoticeAcknowledgment.upsert({
   *   create: {
   *     // ... data to create a PrivacyNoticeAcknowledgment
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the PrivacyNoticeAcknowledgment we want to update
   *   }
   * })
   */
  ...
  /**
   * Count the number of PrivacyNoticeAcknowledgments.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PrivacyNoticeAcknowledgmentCountArgs} args - Arguments to filter PrivacyNoticeAcknowledgments to count.
   * @example
   * // Count the number of PrivacyNoticeAcknowledgments
   * const count = await prisma.privacyNoticeAcknowledgment.count({
   *   where: {
   *     // ... the filter for the PrivacyNoticeAcknowledgments we want to count
   *   }
   * })
  **/
  count<T extends PrivacyNoticeAcknowledgmentCountArgs>(
    args?: Prisma.Subset<T, PrivacyNoticeAcknowledgmentCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PrivacyNoticeAcknowledgmentCountAggregateOutputType>
      : number
  >

  /**
   * Allows you to perform aggregations operations on a PrivacyNoticeAcknowledgment.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PrivacyNoticeAcknowledgmentAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
   * @example
  ...
  **/
  ...
  /**
   * Group by PrivacyNoticeAcknowledgment.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {PrivacyNoticeAcknowledgmentGroupByArgs} args - Group by arguments.
   * @example
  ...
  **/
  groupBy<
    T extends PrivacyNoticeAcknowledgmentGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PrivacyNoticeAcknowledgmentGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPrivacyNoticeAcknowledgmentGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 * Fields of the PrivacyNoticeAcknowledgment model
 */
readonly fields: PrivacyNoticeAcknowledgmentFieldRefs;
}

/**
 * The delegate class that acts as a "Promise-like" for PrivacyNoticeAcknowledgment.
...
// Custom InputTypes
/**
 * PrivacyNoticeAcknowledgment findUnique
 */
export type PrivacyNoticeAcknowledgmentFindUniqueArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  /**
   * Filter, which PrivacyNoticeAcknowledgment to fetch.
   */
  where: Prisma.PrivacyNoticeAcknowledgmentWhereUniqueInput
}

/**
 * PrivacyNoticeAcknowledgment findUniqueOrThrow
 */
...
/**
 * PrivacyNoticeAcknowledgment findFirst
 */
export type PrivacyNoticeAcknowledgmentFindFirstArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for searching for PrivacyNoticeAcknowledgments.
   */
  cursor?: Prisma.PrivacyNoticeAcknowledgmentWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
/**
 * PrivacyNoticeAcknowledgment findMany
 */
export type PrivacyNoticeAcknowledgmentFindManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PrivacyNoticeAcknowledgmentInclude<ExtArgs> | null
  /**
   * Filter, which PrivacyNoticeAcknowledgments to fetch.
   */
  where?: Prisma.PrivacyNoticeAcknowledgmentWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for listing PrivacyNoticeAcknowledgments.
   */
  cursor?: Prisma.PrivacyNoticeAcknowledgmentWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type PrivacyNoticeAcknowledgmentCreateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to create many PrivacyNoticeAcknowledgments.
   */
...
/**
 * PrivacyNoticeAcknowledgment createManyAndReturn
 */
...
/**
 * PrivacyNoticeAcknowledgment update
 */
export type PrivacyNoticeAcknowledgmentUpdateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PrivacyNoticeAcknowledgmentInclude<ExtArgs> | null
  /**
   * The data needed to update a PrivacyNoticeAcknowledgment.
   */
  data: Prisma.XOR<Prisma.PrivacyNoticeAcknowledgmentUpdateInput, Prisma.PrivacyNoticeAcknowledgmentUncheckedUpdateInput>
  /**
   * Choose, which PrivacyNoticeAcknowledgment to update.
   */
  where: Prisma.PrivacyNoticeAcknowledgmentWhereUniqueInput
}

/**
 * PrivacyNoticeAcknowledgment updateMany
 */
export type PrivacyNoticeAcknowledgmentUpdateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to update PrivacyNoticeAcknowledgments.
   */
  ...
  /**
   * Filter which PrivacyNoticeAcknowledgments to update
   */
  where?: Prisma.PrivacyNoticeAcknowledgmentWhereInput
  /**
   * Limit how many PrivacyNoticeAcknowledgments to update.
   */
  limit?: number
}

/**
 * PrivacyNoticeAcknowledgment updateManyAndReturn
 */
...
/**
 * PrivacyNoticeAcknowledgment upsert
 */
export type PrivacyNoticeAcknowledgmentUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PrivacyNoticeAcknowledgmentInclude<ExtArgs> | null
  /**
   * The filter to search for the PrivacyNoticeAcknowledgment to update in case it exists.
   */
  where: Prisma.PrivacyNoticeAcknowledgmentWhereUniqueInput
  /**
   * In case the PrivacyNoticeAcknowledgment found by the `where` argument doesn't exist, create a new PrivacyNoticeAcknowledgment with this data.
   */
  create: Prisma.XOR<Prisma.PrivacyNoticeAcknowledgmentCreateInput, Prisma.PrivacyNoticeAcknowledgmentUncheckedCreateInput>
  /**
   * In case the PrivacyNoticeAcknowledgment was found with the provided `where` argument, update it with this data.
   */
  update: Prisma.XOR<Prisma.PrivacyNoticeAcknowledgmentUpdateInput, Prisma.PrivacyNoticeAcknowledgmentUncheckedUpdateInput>
}

/**
 * PrivacyNoticeAcknowledgment delete
 */
export type PrivacyNoticeAcknowledgmentDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.PrivacyNoticeAcknowledgmentInclude<ExtArgs> | null
  /**
   * Filter which PrivacyNoticeAcknowledgment to delete.
   */
  where: Prisma.PrivacyNoticeAcknowledgmentWhereUniqueInput
}

/**
 * PrivacyNoticeAcknowledgment deleteMany
 */
export type PrivacyNoticeAcknowledgmentDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which PrivacyNoticeAcknowledgments to delete
   */
  where?: Prisma.PrivacyNoticeAcknowledgmentWhereInput
  /**
   * Limit how many PrivacyNoticeAcknowledgments to delete.
   */
  limit?: number
}

/**
 * PrivacyNoticeAcknowledgment.investor
 */
...
/**
 * PrivacyNoticeAcknowledgment.counterparty
 */
...
/**
 * PrivacyNoticeAcknowledgment.publicIntakeSubmission
 */
...
/**
 * PrivacyNoticeAcknowledgment without action
 */
