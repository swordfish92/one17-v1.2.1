...
let AppController = class AppController {
    ...
    getVersion() {
        try {
            const raw = (0, node_fs_1.readFileSync)((0, node_path_1.join)(__dirname, 'VERSION.json'), 'utf-8');
    ...
    async getReady() {
        try {
            ...
            throw new common_1.ServiceUnavailableException({ status: 'not_ready', checks: { database: 'fail' } });
        }
